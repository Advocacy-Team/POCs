 CLASS zdev_cl_creat_ajob_c5331383 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zdev_cl_creat_ajob_c5331383 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.

    DATA lv_job_text TYPE cl_apj_rt_api=>ty_job_text VALUE 'Demo_Job D1KP'.
...
* choose name of existing job template !!!!
    lv_template_name = 'ZMIK_TEMPLATE_D1KP'.
