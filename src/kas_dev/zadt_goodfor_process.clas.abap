...
*     INTO TABLE @it_insplot.
    ...
    SELECT  a~plant,a~material,a~batch,a~insplot
...
*/// IF planned orders exist - call API
        TRY.
            DATA(lo_dest) = cl_http_destination_provider=>create_by_url(
                 i_url    = 'https://my400036-api.s4hana.ondemand.com/sap/opu/odata/sap/API_INSPECTIONPLAN_SRV/A_InspPlanMaterialAssgmt'
              ).
